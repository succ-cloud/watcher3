...
// Public route - used by signup and city selectors
router.get('/business-cities', userController.getBusinessCities);
router.get('/transaction-methods', userController.getTransactionMethods);
router.get('/expense-categories', userController.getExpenseCategories);
 ...
 * @desc    Assign or move a salesperson between shops
 * @access  Admin only
 */
router.patch('/:id/shops',
    verifyRole(ROLES_LIST.ADMIN),
    userController.updateSalesmanShops
);

/**
 * @route   PATCH /api/users/:id/password
 * @desc    Admin sets a new password for any account
 * @access  Admin only
 */
router.patch('/:id/password',
    verifyRole(ROLES_LIST.ADMIN),
    userController.setUserPasswordByAdmin
);

/**
 * @route   PATCH /api/users/:id
 * @desc    Update user profile (admin: any account; others: own profile only)
 * @access  Admin, wholesaler, salesman
 */
router.patch('/:id',
    verifyRole([ROLES_LIST.ADMIN, ROLES_LIST.WHOLESALER, ROLES_LIST.SALESMAN]),
